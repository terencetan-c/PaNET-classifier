#!/bin/bash
#SBATCH --job-name=scibert_panet         # Name of the job
#SBATCH --output=logs/panet_out_%j.txt   # Standard output log (%j = job ID)
#SBATCH --error=logs/panet_err_%j.txt     # Standard error log
